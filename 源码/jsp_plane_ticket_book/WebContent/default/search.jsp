...
<meta charset="UTF-8">
<title>机票预订系统</title>
<link href="/plane_ticket_book/default/css/bootstrap.min.css" rel="stylesheet">
<link href="/plane_ticket_book/default/css/common.css" rel="stylesheet">
<link href="/plane_ticket_book/default/css/corptravel.css" rel="stylesheet">
<link href="/plane_ticket_book/default/css/enterprise.css" rel="stylesheet">
<link href="/plane_ticket_book/default/css/iconfont.css" rel="stylesheet">
<script type="/plane_ticket_book/default/text/javascript" src="js/jquery-1.9.1.min.js"></script>
<script src="/plane_ticket_book/default/js/bootstrap.min.js"></script>
</head>
<body class="bg-body">
	<!-- header -->
	<nav class="navbar navbar-default navbar-fixed-top bg-white">
		<nav class="navbar navbar-default"
			...
			<div class="container font12">
					...
					<li class="dropdown">
						<% if(session.getAttribute("user_id")!=null){ %>
							...
							<ul class="dropdown-menu">
								<li><a href="/plane_ticket_book/default/logout.jsp">退出</a></li>
							</ul>
						<%}else{ %>
							<a href="/plane_ticket_book/user_center" class="dropdown-toggle"  role="button" aria-haspopup="true" aria-expanded="false">
								请登录！
				...
				<ul class="nav navbar-nav navbar-right nav-top-small">
					<li class="dropdown">
						<a href="/plane_ticket_book/default/message_board.jsp" class="dropdown-toggle"> 留言板 </a>
					</li>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class=" " href="/plane_ticket_book/default/index.jsp"><img src="/plane_ticket_book/default/images/logo.png"
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="/plane_ticket_book/default/index.jsp"><i
							class="icon iconfont icon-nav-block font24">&#xe620;</i> 首页</a></li>
					<li><a href="/plane_ticket_book/user_center"><i
	...
	<div class="index-wall white " style="">
		<div class="container"
			...
			<form class="form-inline" action="/plane_ticket_book/search" method="post">
		...
		<div class="hangbanlist">
			<div>
				...
				<ul class="list-inline bor-bottom-solid-1  ">
					<li class="w-percentage-25"><img src="/plane_ticket_book/default/images/air/CA.png"
					...
					<div class="hangbanlist-body " style="background-color: #FEFCFC;">
						<ul class="list-inline">
							...
							<li class="pull-right "><button type="button"
									...
									onClick="window.location.href ='/plane_ticket_book/default/order.jsp?flight_id=<%=flight_info.getF_n() %>&grade=f';">订票</button></li>
						</ul>
						<ul class="list-inline">
							...
							<li class="pull-right "><button type="button"
									class="btn btn-danger btn-sm"
									onClick="window.location.href ='/plane_ticket_book/default/order.jsp?flight_id=<%=flight_info.getF_n() %>&grade=b';">订票</button></li>
						</ul>
						<ul class="list-inline">
							...
							<li class="pull-right "><button type="button"
									class="btn btn-danger btn-sm"
									onClick="window.location.href ='/plane_ticket_book/default/order.jsp?flight_id=<%=flight_info.getF_n() %>&grade=e';">订票</button></li>
						</ul>
					</div>
				</div>
				<!-- 表BODY 结束 -->
