	...
	<div id="login">
		...
		<div class="wrapper">
			...
			<div class="login sign-in-htm">
				<form action="../login_reg" onSubmit="return login(this);" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
			...
			<div class="login sign-up-htm">
				<form action="../login_reg" onSubmit="return register(this)" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
					...
					<div class="pad input-container">
						<section class="content">
							...
							<span class="input input--hideo">
								<input name="reg_phone" class="input__field input__field--hideo" type="text" id="register-phone" 
							...
							<span class="input input--hideo">
								<input name="reg_city" class="input__field input__field--hideo" type="text" id="register-city" 
									autocomplete="off" placeholder="请输入城市" maxlength="15"/>
								<label class="input__label input__label--hideo" for="register-username">
									<i class="fa fa-fw fa-user icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
							...
							<span class="input input--hideo">
								<input name="reg_cid" class="input__field input__field--hideo" type="text" id="register-cid" 
									autocomplete="off" placeholder="请输入身份证" maxlength="15"/>
								<label class="input__label input__label--hideo" for="register-username">
									<i class="fa fa-fw fa-user icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
