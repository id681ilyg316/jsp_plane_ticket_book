						...
						<div class="ydc-panes">
							<div class="ydc-pane ydc-pane-clear" style="display: block;">
								...
								<div class="ydc-reg-form-group clearfix">
									<label>所在城市</label>
									<div class="ydc-reg-form-input">
										<label><%=session.getAttribute("city") %></label>
									</div>
								</div>
								<div class="ydc-reg-form-group clearfix">
									<label>身份证号</label>
									<div class="ydc-reg-form-input">
										<label><%=session.getAttribute("sfz") %></label>
									</div>
								</div>
								...
								<div class="ydc-reg-form-group clearfix">
									<label>联系手机</label>
									<div class="ydc-reg-form-input">
										<label><%=session.getAttribute("phone") %></label>
									</div>
								</div>
								<div class="ydc-reg-form-group clearfix">
									<label>邮箱</label>
								...
								<div class="ydc-reg-form-group clearfix">
									<label>QQ/微信</label>
									<div class="ydc-reg-form-input">
										<label><%=session.getAttribute("qq") %></label>
									</div>
								</div>
								<div class="ydc-reg-form-group clearfix"
									style="margin-top: 40px;">
									<div class="ydc-reg-form-button" style="margin-left: 255px;">
										<a class="btn fl" href="/plane_ticket_book/index/edit_info.jsp">修改</a>
									</div>
								</div>
							</div>
						</div>
