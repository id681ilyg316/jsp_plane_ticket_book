...
<meta charset="UTF-8">
<title>用户中心</title>
<link type="text/css" rel="stylesheet" href="/plane_ticket_book/index/css/core.css">
<link type="text/css" rel="stylesheet" href="/plane_ticket_book/index/css/icon.css">
<link type="text/css" rel="stylesheet" href="/plane_ticket_book/index/css/home.css">
</head>
<body>
					...
					<div class="ydc-user-info">
						...
						<div class="ydc-user-info-func ydc-flex">
							...
							<span class="ydc-mal"><i
								...
								href="/plane_ticket_book/index/logout.jsp">退出</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="ydc-content-slide ydc-body" style="height:86%;">
		<div class="ydc-flex" style="height:100%;">
				...
				<div class="ydc-menu">
					<ul>
						<li class="ydc-menu-item"><span class="ydc-menu-sub-title">
							...
							<ul>
								<li><a target="frame" href="/plane_ticket_book/index/user_info.jsp"
									>个人资料</a></li>
								<li><a target="frame" href="/plane_ticket_book/index/edit_info.jsp">修改信息</a></li>
							</ul></li>
						...
						<li class="ydc-menu-item">
							...
							<ul>
								<li><a target="frame" href="/plane_ticket_book/index/order_list.jsp">订单列表</a></li>
							</ul>
						</li>
						...
						<li class="ydc-menu-item"><span class="ydc-menu-sub-title">
							...
							<ul>
								<li><a href="/plane_ticket_book/default/index.jsp">返回首页</a></li>
							</ul></li>
			...
			<div style="width:76%;height:100%;">
				<iframe name="frame" scrolling="auto" width="100%" height="100%" frameborder="0" src="/plane_ticket_book/index/user_info.jsp"></iframe>
			</div>
			<!-- right end -->
		</div>
	</div>
