...
public class check_login_reg extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		String reg_phone = req.getParameter("reg_phone");
		String reg_city = req.getParameter("reg_city");
		String reg_cid = req.getParameter("reg_cid");
		...
		if(log_name!=null&&log_pwd!=null&&reg_name==null&&reg_pwd1==null&&reg_pwd2==null) {
			...
			//调用注册方法处理注册
			go_reg(reg_name, reg_pwd1, req, resp, reg_city, reg_phone, reg_cid);
	...
	protected void go_reg(String name, String pwd1,HttpServletRequest req, HttpServletResponse resp,String reg_city,String reg_phone,String reg_cid) {
		...
		try {
			...
			try {
				if(res.next()) {			
					...
					sql = "insert into common_user (user_name,user_pwd,city,sfz,phone) values('"+name+"','"+pwd1+"','"+reg_city+"','"+reg_cid+"','"+reg_phone+"')";
